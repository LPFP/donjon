...
<nav class="well well-small">
    <?= $this->Html->link(__('Edit <%= $singularHumanName %>'), ['action' => 'edit', <%= $pk %>], ['class' => 'btn']) ?> </li>
<?php echo $this->Form->postLink(__('Delete <%= $singularHumanName %>'), ['action' => 'delete', <%= $pk %>], ['confirm' => __('Are you sure you want to delete # {0}?', <%= $pk %>)]) ?> 
<?php echo $this->Html->link(__('List <%= $pluralHumanName %>'), ['action' => 'index']) ?> 
<?php echo $this->Html->link(__('New <%= $singularHumanName %>'), ['action' => 'add']) ?> 
<%
$done = [];
...
<div class=" row <%= $pluralVar %> view large-9 medium-8 columns content">
    <div class="col-12">
