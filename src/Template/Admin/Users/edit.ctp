...
<div class="row">
    <div class="span12">
        <div class="well well-small">
            ...
            __('Delete'), ['action' => 'delete', $user->id], ['class' => 'pull-right btn btn-sm btn-danger'], ['confirm' => __('Are you sure you want to delete # {0}?', $user->id)]
            )
            ?>
    ...
    <div class="span12">
        <div class="users">
            ...
            <fieldset>
                ...
                <?php
                echo $this->Form->label('email', ['type' => 'file']);
